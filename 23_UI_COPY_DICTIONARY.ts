...
export const uiCopy = {
  ...
  errors: {
    ...
    entityNotFound: "Объект не найден в демо-данных",
  },
  ...
  demo: {
    ...
    aiDisclaimer:
      "Это демонстрационный сценарий на основе искусственного интеллекта. Для реальных решений проверяйте актуальные официальные источники.",
  },
