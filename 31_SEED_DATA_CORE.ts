...
export const organizations: Organization[] = [
  ...
  },
  {
    ...
    category: "education",
    verified: true,
    description: "Demo-провайдер образовательных программ.",
    city: "Москва",
  },
];
...
export const places: Place[] = [
  {
    ...
    description: "Demo-карточка клиники.",
  },
  {
    id: "place_library",
...
export const courses: Course[] = [
  {
    ...
    format: "online",
    duration: "8 недель",
    description: "Demo-курс по базовым принципам digital-дизайна.",
    accessibility: {
      subtitles: true,
      transcript: true,
...
export const events: Event[] = [
  {
    ...
    description: "Demo-мероприятие для проверки event flow.",
...
export const articles: Article[] = [
  {
    ...
    category: "transport",
    summary: "Короткий demo-чеклист перед поездкой.",
    body: [
