...
const verificationEntityLabels: Record<AdminVerificationItem["entityType"], string> = {
  partner: "партнёр",
  volunteer: "волонтёр",
  author: "автор",
  place: "место",
