...
export function Chip({ className, selected, size = "md", ...props }: ChipProps) {
  return (
    <button
      type="button"
      className={cn(
        "inline-flex shrink-0 whitespace-nowrap items-center rounded-full border font-medium transition-[background-color,border-color,box-shadow] active:shadow-inset focus-visible:ring-4 focus-visible:ring-focus/20",
