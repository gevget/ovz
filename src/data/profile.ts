...
export const profileNotifications: ProfileNotification[] = [
  ...
  { id: "notif_013", userId: "user_anna", category: "community", title: "Новая публикация в «Дизайн и цифровые технологии»", body: "Тимур поделился чек-листом доступного интерфейса.", read: true, dateGroup: "yesterday", timeLabel: "09:30", deepLink: routes.user.communityDetail("community_design") },
